        ...
        if(windowWidth > 0) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.company-logo img').attr('src', 'static/img/logos/black-logo.png');// Modifies by me (Matthias Mesfin) added static/ to the url
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1 && $('.fixed-header').length == 0 && $('.fixed-header2').length == 0) {
                    $('.company-logo img').attr('src', 'static/img/logos/logo.png');// Modifies by me (Matthias Mesfin)
                } else {
                    $('.company-logo img').attr('src', 'static/img/logos/black-logo.png');// Modifies by me (Matthias Mesfin)
                }
            }
        } else {
            $('.company-logo img').attr('src', 'static/img/logos/black-logo.png');// Modifies by me (Matthias Mesfin)
